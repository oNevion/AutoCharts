...
GLOBAL $FundFamily = ""
#Region ### START Koda GUI section ### Form=c:\users\mrjak\documents\sublimeprojects\autocharts\assets\gui_main.kxf
...
Func OpenSettingsGUI()
	...
	Global $INPT_DropboxFolder = GUICtrlCreateInput("X:\", 16, 16, 201, 21)
	Global $BTN_Save = GUICtrlCreateButton("Save", 16, 48, 75, 25)
	Global $BTN_Cancel = GUICtrlCreateButton("Cancel", 144, 48, 75, 25)
	GUISetState(@SW_SHOW)
	#EndRegion ### END Koda GUI section ###
