...
// Set up data source
chart1.dataSource.url = "../Data/Backups/Catalyst/CLP/CLP_EXPORT_10kChart.csv";
...
dateAxis.renderer.labels.template.fontSize = "18px";
...
valueAxis.renderer.labels.template.fontSize = "18px";
...
series1.dataFields.valueY = "CLPFX";
...
chart1.legend.labels.template.fontSize = "16px";
...
chart1.exporting.filePrefix = "CLP_10k";

// ################################   CHART 2 CLP Sector Weights (Bar) ################################################
...
// Set up data source
chart2.dataSource.url = "../Data/Backups/Catalyst/CLP/CLP_EXPORT_SectorAllocationBar.csv";
...
series.dataFields.valueX = "NASDAQ-100 Index";
series.dataFields.categoryY = "Sector";
series.name = "NASDAQ-100 Index";
...
series2.dataFields.valueX = "CLPFX";
series2.dataFields.categoryY = "Sector";
series2.name = "CLPFX";
...
chart2.exporting.filePrefix = "CLP_SectorAllocation";
