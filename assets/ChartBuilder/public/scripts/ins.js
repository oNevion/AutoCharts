...
// Set up data source
chart1.dataSource.url = "../Data/Backups/Catalyst/INS/INS_EXPORT_AnnualReturn.csv";
...
series.dataFields.valueY = "INSAX";
...
chart1.legend.labels.template.fontSize = "23px";
chart1.legend.labels.template.minWidth = 125;
...
chart1.exporting.filePrefix = "INS_AnnualReturn";


// ################################ CHART 2 INS 10k Chart (Line) ################################################
...
// Set up data source
chart2.dataSource.url = "../Data/Backups/Catalyst/INS/INS_EXPORT_10kChart.csv";
...
series1.dataFields.valueY = "INSAX";
...
chart2.exporting.filePrefix = "INS_10k";
