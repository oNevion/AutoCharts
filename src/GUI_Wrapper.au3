...
$Form1 = _Metro_CreateGUI("AutoCharts 3.0.0", 540, 700, -1, -1, True)
...
Local $BTN_Settings = _Metro_CreateButton("Settings", 50, 600, 100, 40, 0xcccccc, 0x00796b)
Local $BTN_About = _Metro_CreateButton("About", 170, 600, 100, 40, 0xcccccc, 0x00796b)
...
Func _CatalystFundsGUI()
	...
	Local $BTN_RunCatalyst = _Metro_CreateButton("Process Updates", 50, 550, 210, 40)
	Local $BTN_Catalyst_UpdateExpenseRatio = _Metro_CreateButton("Update Expense Ratios", 280, 550, 210, 40, 0xcccccc, 0x00796b)
	Local $BTN_Back = _Metro_AddControlButton_Back()
	Local $ProgressBar = _Metro_CreateProgress(50, 500, 440, 26)
		...
		Switch $nMsg
			...
			Case $ACX
				If _Metro_ToggleIsChecked($ACX) Then
					...
					$aCatalystCheck[0] = "ACX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($ACX)
					$aCatalystCheck[0] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
			...
			Case $ATR
				If _Metro_ToggleIsChecked($ATR) Then
					...
					$aCatalystCheck[1] = "ATR" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($ATR)
					$aCatalystCheck[1] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $BUY
				If _Metro_ToggleIsChecked($BUY) Then
					...
					$aCatalystCheck[2] = "BUY" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($BUY)
					$aCatalystCheck[2] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $CAX
				If _Metro_ToggleIsChecked($CAX) Then
					...
					$aCatalystCheck[3] = "CAX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($CAX)
					$aCatalystCheck[3] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $CFR
				If _Metro_ToggleIsChecked($CFR) Then
					...
					$aCatalystCheck[4] = "CFR" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($CFR)
					$aCatalystCheck[4] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $CLP
				If _Metro_ToggleIsChecked($CLP) Then
					...
					$aCatalystCheck[5] = "CLP" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($CLP)
					$aCatalystCheck[5] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $CLT
				If _Metro_ToggleIsChecked($CLT) Then
					...
					$aCatalystCheck[6] = "CLT" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($CLT)
					$aCatalystCheck[6] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $CPE
				If _Metro_ToggleIsChecked($CPE) Then
					...
					$aCatalystCheck[7] = "CPE" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($CPE)
					$aCatalystCheck[7] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $CWX
				If _Metro_ToggleIsChecked($CWX) Then
					...
					$aCatalystCheck[8] = "CWX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($CWX)
					$aCatalystCheck[8] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $DCX
				If _Metro_ToggleIsChecked($DCX) Then
					...
					$aCatalystCheck[9] = "DCX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($DCX)
					$aCatalystCheck[9] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $EIX
				If _Metro_ToggleIsChecked($EIX) Then
					...
					$aCatalystCheck[10] = "EIX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($EIX)
					$aCatalystCheck[10] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $HII
				If _Metro_ToggleIsChecked($HII) Then
					...
					$aCatalystCheck[11] = "HII" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($HII)
					$aCatalystCheck[11] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $IIX
				If _Metro_ToggleIsChecked($IIX) Then
					...
					$aCatalystCheck[12] = "IIX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($IIX)
					$aCatalystCheck[12] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $INS
				If _Metro_ToggleIsChecked($INS) Then
					...
					$aCatalystCheck[13] = "INS" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($INS)
					$aCatalystCheck[13] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $IOX
				If _Metro_ToggleIsChecked($IOX) Then
					...
					$aCatalystCheck[14] = "IOX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($IOX)
					$aCatalystCheck[14] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $MBX
				If _Metro_ToggleIsChecked($MBX) Then
					...
					$aCatalystCheck[15] = "MBX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($MBX)
					$aCatalystCheck[15] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $MLX
				If _Metro_ToggleIsChecked($MLX) Then
					...
					$aCatalystCheck[16] = "MLX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($MLX)
					$aCatalystCheck[16] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $SHI
				If _Metro_ToggleIsChecked($SHI) Then
					...
					$aCatalystCheck[17] = "SHI" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($SHI)
					$aCatalystCheck[17] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $TEZ
				If _Metro_ToggleIsChecked($TEZ) Then
					...
					$aCatalystCheck[18] = "TEZ" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($TEZ)
					$aCatalystCheck[18] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $TRI
				If _Metro_ToggleIsChecked($TRI) Then
					...
					$aCatalystCheck[19] = "TRI" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($TRI)
					$aCatalystCheck[19] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $TRX
				If _Metro_ToggleIsChecked($TRX) Then
					...
					$aCatalystCheck[20] = "TRX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($TRX)
					$aCatalystCheck[20] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
...
Func _RationalFundsGUI()
	...
	Local $BTN_Rational_UpdateExpenseRatio = _Metro_CreateButton("Update Expense Ratios", 280, 550, 210, 40, 0xcccccc, 0x00796b)
	Local $BTN_Back = _Metro_AddControlButton_Back()
	Local $ProgressBar = _Metro_CreateProgress(50, 500, 440, 26)
		...
		Switch $nMsg
			...
			Case $HBA
				If _Metro_ToggleIsChecked($HBA) Then
					...
					$aRationalCheck[0] = "HBA" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($HBA)
					$aRationalCheck[0] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $HDC
				If _Metro_ToggleIsChecked($HDC) Then
					...
					$aRationalCheck[1] = "HDC" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($HDC)
					$aRationalCheck[1] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $HRS
				If _Metro_ToggleIsChecked($HRS) Then
					...
					$aRationalCheck[2] = "HRS" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($HRS)
					$aRationalCheck[2] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $HSU
				If _Metro_ToggleIsChecked($HSU) Then
					...
					$aRationalCheck[3] = "HSU" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($HSU)
					$aRationalCheck[3] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $PBX
				If _Metro_ToggleIsChecked($PBX) Then
					...
					$aRationalCheck[4] = "PBX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($PBX)
					$aRationalCheck[4] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $RDM
				If _Metro_ToggleIsChecked($RDM) Then
					...
					$aRationalCheck[5] = "RDM" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($RDM)
					$aRationalCheck[5] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $RFX
				If _Metro_ToggleIsChecked($RFX) Then
					...
					$aRationalCheck[6] = "RFX" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($RFX)
					$aRationalCheck[6] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
		...
		Switch $nMsg
			...
			Case $GLDB
				If _Metro_ToggleIsChecked($GLDB) Then
					...
					$aStrategyCheck[0] = "GLDB" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($GLDB)
					$aStrategyCheck[0] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $HNDL
				If _Metro_ToggleIsChecked($HNDL) Then
					...
					$aStrategyCheck[1] = "HNDL" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($HNDL)
					$aStrategyCheck[1] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
			...
			Case $ROMO
				If _Metro_ToggleIsChecked($ROMO) Then
					...
					$aStrategyCheck[2] = "ROMO" ; Sets first slot of the Catalyst Array to 1 if CHECKED
					ConsoleWrite("Toggle unchecked!" & @CRLF)
				Else
					_Metro_ToggleCheck($ROMO)
					$aStrategyCheck[2] = 0 ; Sets first slot of the Catalyst Array to 0 if NOT CHECKED
					ConsoleWrite("Toggle checked!" & @CRLF)
				EndIf
...
Func SettingsGUI()
	...
	Local $Form5 = _Metro_CreateGUI("AutoCharts Settings", 540, 620, -1, -1, False, $Form1)
	;Add control buttons
	Local $Control_Buttons_2 = _Metro_AddControlButtons(True, False, False, False)
	Local $GUI_CLOSE_BUTTON = $Control_Buttons_2[0]
	...
	Local $BTN_Cancel = _Metro_CreateButton("Cancel", 280, 550, 210, 40, 0xcccccc, 0x00796b)
...
Func _HelpGUI()
	...
	Local $Form6 = _Metro_CreateGUI("AutoCharts Help", 540, 500, -1, -1, False, $Form1)
	;Add control buttons
	Local $Control_Buttons_2 = _Metro_AddControlButtons(True, False, False, False)
	Local $GUI_CLOSE_BUTTON = $Control_Buttons_2[0]
	...
	Local $BTN_About = _Metro_CreateButton("About AutoCharts", 50, 100, 420, 40)
	Local $BTN_OpenLog = _Metro_CreateButton("Open Log File", 50, 160, 420, 40)
	Local $BTN_ClearLog = _Metro_CreateButton("Clear Log File", 50, 220, 420, 40)
	Local $BTN_CheckForUpdate = _Metro_CreateButton("Check for Update", 50, 280, 420, 40)
